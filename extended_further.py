...
# Load dataset with increased training samples
...
validloader = DataLoader(validset, batch_size=16, shuffle=False, num_workers=0, pin_memory=True)
testloader = DataLoader(testset, batch_size=16, shuffle=False, num_workers=0, pin_memory=True)
...
previous_version = 'extended_15k_samples_v1'
new_version = 'extended_15k_samples_optimized_v2'
